...
plot(datapc2$DateTime, datapc2$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

plot(datapc2$DateTime, datapc2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(datapc2$DateTime, datapc2$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
